    ...
    <View>
      ...
      <View style={styles.container}>
        <View style={styles.headerButtonsContainer}>
          ...
          <View style={styles.headerButtons}>
            <TouchableOpacity style={styles.button}>
                <MaterialIcon name="notifications" size={20} color="#4BB0EE"></MaterialIcon> 
            </TouchableOpacity>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.textButtonHeader} >Follow</Text>
            </TouchableOpacity>
            </View>
        </View>
        ...
        <View style={styles.infoContainer}>
          ...
          <Text style={styles.info}>Nascido em 30 de maio de 1997</Text>
        </View>
        <View style={styles.infoContainer}>
          <EvilIcons name="calendar" size={24} color="#4BB0EE"/>
          <Text style={styles.info}>Entrou em Julho de 2015</Text>
        </View>
        ...
        <View style={styles.followContainer}>
          ...
          <TouchableOpacity>
            <Text style={styles.buttonContainerText}>Tweets and Replies</Text>
          </TouchableOpacity>
          <TouchableOpacity>
